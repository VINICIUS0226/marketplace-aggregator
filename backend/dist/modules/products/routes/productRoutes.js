 ...
 */
productsRouter.post("/compare", (0, asyncHandler_1.asyncHandler)(productController.compare.bind(productController)));
/**
 * @swagger
 * /products/{id}:
 *   get:
 ...
 */
productsRouter.get("/:id", (0, asyncHandler_1.asyncHandler)(productController.show.bind(productController)));
